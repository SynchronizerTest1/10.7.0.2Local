...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <referenced-types>
      <type name="KappletReturnValue"/>
    </referenced-types>
    <referenced-snippets/>
    <typed-variables>
      <typed-variable name="kappletReturnValue" type-name="KappletReturnValue"/>
    </typed-variables>
    <global-variables/>
    <parameters>
      <parameter name="kappletReturnValue" type-name="KappletReturnValue"/>
    </parameters>
    <return-variables>
      <variable name="kappletReturnValue"/>
    </return-variables>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="0">kappletReturnValue</property>
      <property name="parameter" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">KappletReturnValue</property>
        </property>
        <property name="assignments" class="AttributeAssignments">
          <property name="yourinput" class="AttributeAssignment">
        ...
        <property name="stepAction" class="WriteLog2">
          <property name="expression" class="kapow.robot.plugin.common.support.expression.multipletype.VariableExpression" serializationversion="2">
            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
              <property name="name" class="String">kappletReturnValue.yourinput</property>
            </property>
          </property>
        </property>
